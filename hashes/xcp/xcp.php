...
include_once dirname(__FILE__).'/xcp.class.php';


if (!class_exists('XcpHashAPI')) {
	class XcpHashAPI extends hashAPI {
		...
		function __construct() {
			parent::setInfo(array('function'=>'getXcp', 'author'=>'Simon Roberts', 'description'=>'XCP Hashinfo/Checksum'));
 ...
 * @param array $options
 */
if (!function_exists('getXcp'))
{
	function getXcp($data = NULL, $options = array())
	{
